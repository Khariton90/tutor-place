...
export function Modal({ onOpen }: ModalProps): JSX.Element {
  return (
    <div className="modal">
      <svg
      ...
      <form className="modal__form">
        ...
        <input className="modal__field" type="email" placeholder="Ваш email" />
        <button type="submit" className="btn-primary" onClick={onOpen}>
          Оплатить
        </button>
      </form>
    </div>
